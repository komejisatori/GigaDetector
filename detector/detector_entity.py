...
class Detector(object):
    def __init__(self, detector_name=detect_cfg['name'], is_pretrained=False):
        self.detector_name = detector_name
        self.detector = None
        self.is_pretrained = is_pretrained
        assert detector_name in detect_cfg['name_list']
        self.cfg = detect_cfg['cfg_list'][detect_cfg['name_list'].index(detector_name)]
        print('[detector] load {}'.format(detector_name))
