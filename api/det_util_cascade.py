...
PRETRAIN_MODEL = True # True from coco pretrain model, False for finetune model
PREFIX = '/home/wangzerun/giga'
DETECTOR_TYPE = 'cascade_rcnn' #faster_rcnn cascade_rcnn retina_net
MODEL_CFG_PRETRAIN = {
